...
bs_paper_self = data.frame(read.csv("ZT02_r1_covhomer_paper", header=TRUE, sep = "\t"))
bs_paper_self = data.frame(bs_paper_self[order(bs_paper_self[1]),])

bs_paper_self[,20] = data.frame(read.csv("ZT02_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT02_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+bs_paper_self[,20]
bs_paper_self[,21] = data.frame(read.csv("ZT06_r1_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT06_r1_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+data.frame(read.csv("ZT06_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT06_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]
bs_paper_self[,22] = data.frame(read.csv("ZT10_r1_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT10_r1_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+data.frame(read.csv("ZT10_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT10_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]
bs_paper_self[,23] = data.frame(read.csv("ZT14_r1_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT14_r1_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+data.frame(read.csv("ZT14_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT14_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]
bs_paper_self[,24] = data.frame(read.csv("ZT18_r1_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT18_r1_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+data.frame(read.csv("ZT18_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT18_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]
bs_paper_self[,25] = data.frame(read.csv("ZT22_r1_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT22_r1_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]+data.frame(read.csv("ZT22_r2_covhomer_paper", header=TRUE, sep = "\t"))[order(data.frame(read.csv("ZT22_r2_covhomer_paper", header=TRUE, sep = "\t"))[1]),][,20]
